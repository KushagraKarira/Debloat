com.android.LGSetupWizard # It's the setup for LG services.
com.lge.appbox.client # LG Application manager
com.lge.bnr # LG Backup
com.lge.cic.eden.service # Memories album
com.lge.cloudhub # LG Cloud
com.lge.drmservice # DRM Service
com.lge.easyhome # LG EasyHome
com.lge.eltest # ELTests # Device hardware tests settings
com.lge.email # LG Email app
com.lge.eula # LG EULA (Terms of Use) accessible in the settings.
com.lge.eulaprovider # License Provider
com.lge.fmradio # FM radio app
com.lge.friendsmanager # LG Friends Manager (https://play.google.com/store/apps/details?id=com.lge.friendsmanager)
com.lge.gallery.collagewallpaper # LG Collage Wallpapers
com.lge.gallery.vr.wallpaper # LG 360 Image Wallpaper
com.lge.gcuv #@siraltus from XDA thinks it refers to Gauce Components which seems to be the LG's version of CSC 
com.lge.gestureanswering #Allows you to bring the phone to your ear to answer an incoming call automatically.
com.lge.gnss.airtest # GNSS Air Test
com.lge.gnsslogcat # GNSS Logcat
com.lge.gnsspostest # GNSS Position test
com.lge.gnsstest # GNSS Test
com.lge.hifirecorder # LG Audio Recorder
com.lge.hotspotlauncher # LG Mobile Hotspot
#com.lge.ia.task.incalagent # InCalAgent
com.lge.ia.task.smartcare #LIA SmartDoctor Engine
com.lge.ia.task.smartsetting # SmartSetting
com.lge.iftttmanager # LG Smart settings # IFTTT = “if this, then that.”. Smart Settings can be seens as IFTTT.
#com.lge.ime # LG Stock Keyboard
com.lge.ime.solution.handwriting # Handwriting feature on the LG keyboard
com.lge.ime.solution.text # XT9 # Text predicting and correction for the LG keyboard.
com.lge.launcher2.theme.optimus # Optimus theme for the LG launcher (v2)
com.lge.leccp # LG Connectivity Service
com.lge.lgaccount # LG Account
com.lge.lgdrm.permission # Handle permissions for LG DRM (com.lge.drmservice).
