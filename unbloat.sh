...
adb shell pm uninstall --user 0 com.android.mms #Mensajes
...
adb shell pm uninstall --user 0 com.mi.android.globalFileexplorer #Administrador de archivos
adb shell pm uninstall --user 0 com.miui.analytics #Analytics
adb shell pm uninstall --user 0 com.miui.bugreport #Mi Feedback
adb shell pm uninstall --user 0 com.miui.calculator #Calculadora
adb shell pm uninstall --user 0 com.miui.compass #Mi Compass
adb shell pm uninstall --user 0 com.miui.msa.global #mas (main system advertising)
